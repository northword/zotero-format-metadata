...
import { existsSync, lstatSync, writeFileSync, readFileSync, mkdirSync, readdirSync, rmSync } from "fs";
...
async function main() {
    ...
    await zip.compressDir(join(buildDir, "addon"), join(buildDir, `${name}.xpi`), {
        ignoreBase: true,
    });
