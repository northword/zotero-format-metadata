...
pref-general-add-check-duplication = 
    .label = Detect duplicates for new items
pref-general-add-check-webpage = 
    .label = Detect potential mistakes when adding web page items
...
pref-std-publicationTitle = 
    .label = Fix publicationTitle case
pref-std-abbr = 
...
pref-abbr-type-label = Types of abbreviations: 
pref-abbr-type-iso4 = 
