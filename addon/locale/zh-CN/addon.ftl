...
menuitem-getFieldsByDOIForSelected = 通过DOI更新字段（选定）
menuitem-getFieldsByDOIForAll = 通过DOI更新字段（所有）
menuitem-setDoi = 统一DOI格式
...
info-batchBegin = 正在处理中，请耐心等待...
info-batchFinish = 处理完成
